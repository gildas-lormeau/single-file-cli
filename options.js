...
const OPTIONS_INFO = [{
	...
	"browser-single-process": { description: "Run the browser as a single process (enabled by default on Windows only, where it applies only to Google Chrome since other browsers exit in this mode, current browsers on other platforms do not support this mode)", type: "boolean", defaultValue: build.os == "windows" },
