...
function getReferer(url, documentUrl) {
	...
	if (!HTTP_PROTOCOLS.includes(documentLocation.protocol) || !HTTP_PROTOCOLS.includes(location.protocol) ||
		(documentLocation.protocol == HTTPS_PROTOCOL && location.protocol != HTTPS_PROTOCOL)) {
		return "";
	}
	if (location.origin == documentLocation.origin) {
		documentLocation.hash = "";
		documentLocation.username = "";
		documentLocation.password = "";
		return documentLocation.href;
	}
	return documentLocation.origin + "/";
}
